    ...
    <div className="container mx-auto mt-8">
      ...
      <div className="flex justify-center space-x-4">
        {classes.map((cls) => (
          <button
            key={cls}
            className={`px-4 py-2 rounded ${cls === selectedClass ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-800'
              }`}
...
const SubjectBox: React.FC<SubjectBoxProps> = ({ subject }) => (
  <div className="bg-white p-4 rounded shadow-md">
    <img src={subject.image} alt={`${subject.name} Image`} className="w-full h-32 object-cover mb-4 rounded" />
